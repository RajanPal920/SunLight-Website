...
const Stainless309HRoundBarsPage = () => {
  ...
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "309h-stainless-steel-roundbars",
  );
  ...
  return (
    <>
      <Helmet>
        <title>
          Stainless Steel 309H Round Bars & Rods | Sunlight Forge & Fitting
        </title>
        <meta
          name="description"
          content="High Stainless Steel 309H Round Bars & Rods Manufacturer. SS 309H Hex Bars, Square Bars & Round Rods Supplier in India."
        />
      </Helmet>
            ...
            <div className="flex-1 min-w-0 pt-4">
                  ...
                  <div className="max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                      {currentProduct?.title ||
                        "Stainless Steel 309H Round Bars & Rods"}
                    </h1>
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={roundBarImage}
                    alt={currentProduct?.title || "SS 309H Round Bars"}
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  {currentProduct?.title ||
                    "Stainless Steel 309H Round Bars & Rods"}{" "}
                  - Manufacturers & Exporters of Stainless Steel 309H Round Bars
                  & UNS S30909 Round Rods, SS 309 Bright Bars, Steel 309H Rods,
                  309H Hexagonal Bar Suppliers in India.
                </p>
                <p>
                  <span className="font-semibold text-[#4A148C]">
                    {contactDetails.company}
                  </span>{" "}
                  are involved in manufacturing & exporting stainless steel 309H
                  round bars which are highly demanded due to their dimensional
                  accuracy, durability, corrosion resistance and excellent
                  finish. These are offered in various shapes and sizes based on
                  the customer's requirement.
                </p>
                <p>
                  Even after being manufactured SS 309H round bars with
                  high-grade steel, our offered round bars are checked
                  thoroughly on various parameters to ensure flawlessness.
                  Moreover, the clients can avail the Stainless Steel Rods at
                ...
                <p>
                  Stainless Steel 309H Round Rods Manufacturer, SS 309H Forged
                  Bar, Steel 309H Hex Bar, Stainless 309H Hollow Bar, UNS S30909
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  SS 309H Round Bars & Steel 309H Round Rods{" "}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      <p>
                        ...
                        Stainless Steel 309H (UNS S30909)
                      </p>
                      <p>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR SS 309H ROUND BARS, STEEL 309H BARS,
                  STAINLESS STEEL 309H RODS, STEEL 309H ROUND RODS, SS 309H RODS
                </h2>
...
export default Stainless309HRoundBarsPage;
