...
const Inconel600Page = () => {
  ...
  // Find the specific product type (Inconel 600)
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "inconel-600-pipestubes",
  );
  ...
  return (
    <>
      <Helmet>
        <title>Inconel 600 Pipes & Tubes | Sunlight Forge & Fitting</title>
        <meta
          name="description"
          content="High Inconel 600 Pipes & Tubes Manufacturer. UNS N06600 Seamless & Welded Pipes, Tubes. Export quality, best prices."
        />
      </Helmet>
                            ...
                            <li key={type.id}>
                              <Link
                                ...
                                className={`text-xs text-slate-600 hover:text-[#66BB6A] hover:bg-green-50 transition-all duration-200 block py-1 px-2 rounded ${
                                  type.slug === "inconel-600-pipestubes"
            ...
            <div className="flex-1 min-w-0 pt-4">
                ...
                <div className="relative p-8 sm:p-12 text-white">
                  <div className="max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                      {currentProduct?.title || "Inconel 600 Pipes & Tubes"}
                    </h1>
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={pipesTubesImage}
                    alt={currentProduct?.title || "Inconel 600 Pipes & Tubes"}
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  {currentProduct?.title || "Inconel 600 Pipes & Tubes"} -
                  Manufacturers & Exporters of Inconel 600 Pipes & Tubes,
                  Inconel Alloy UNS N06600 Seamless Pipes & Seamless Tubes,
                  Inconel 600 Welded Pipes & Welded Tubes in India.
                </p>
                <p>
                  <span className="font-semibold text-[#4A148C]">
                    {contactDetails.company}
                  </span>{" "}
                  is a well-known manufacturer & Exporters of Inconel 600 Pipe &
                  Tubes. Inconel 600 Pipe are usually used in industries such as
                  chemical processing, aerospace, marine engineering, nuclear
                  engineering, food processing, paper, machinery, and others.
                </p>
                <p>
                  Inconel 600 is a nickel-chromium alloy with excellent
                ...
                <p>
                  The Inconel 600 Pipes & Tubes are manufactured to sustain very
                ...
                <p>
                  ...
                  Inconel 600 Seamless Pipes & Tubes are offered in customized
                  length sizes and shapes to our esteemed clients. Also referred
                  as UNS N06600, we offer these Inconel Seamless Pipes & Tubes
                  at best possible rates in the market.
                </p>
                <p>
                  Our product includes tubes and pipes, Inconel 600 Pipes,
                  Inconel 600 Tubes, Inconel 600 Seamless Pipes & Tubes etc.
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Inconel 600 Seamless & Inconel 600 Welded{" "}
                ...
                <div className="bg-green-50 rounded-2xl p-6 sm:p-8 border border-green-200">
                  ...
                  <p className="text-slate-600 mt-4 pt-4 border-t border-green-200 text-sm">
                    Inconel 600 Pipes, Inconel 600 Tubes, Inconel Alloy
                    Werkstoff Nr.2.4816 Seamless Pipes & Tubes, Inconel 600
                    Welded Pipes Supplier, Inconel Alloy 600 EFW / ERW Pipes &
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  High Inconel 600 Pipes & Tubes UNS N06600 Pipes{" "}
                  <br className="hidden sm:block" />
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">72.0 min</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Cr</td>
                        <td className="px-6 py-2.5 text-sm">14.0 - 17.0</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Fe</td>
                        <td className="px-6 py-2.5 text-sm">6.0 - 10.0</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">0.15 max</td>
                      </tr>
                      <tr>
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      <tr>
                        ...
                        <td className="px-4 py-2.5 text-sm">NA 14</td>
                        <td className="px-4 py-2.5 text-sm">НП-2</td>
                        <td className="px-4 py-2.5 text-sm">NW 6600</td>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR INCONEL 600 PIPES, INCONEL 600 TUBES,{" "}
                  <br className="hidden sm:block" />
                  <span className="text-[#66BB6A]">
                    INCONEL 600 SEAMLESS PIPES, INCONEL 600 WELDED TUBES
                  </span>
                </h2>
