...
const Monel400Page = () => {
  ...
  // Find the specific product type (Monel 400)
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "monel-400-pipestubes",
  );
  ...
  return (
    <>
      <Helmet>
        <title>Monel 400 Pipes & Tubes | Sunlight Forge & Fitting</title>
        <meta
          name="description"
          content="High Monel 400 Pipes & Tubes Manufacturer. UNS N04400 Seamless & Welded Pipes, Tubes. Export quality, best prices."
        />
      </Helmet>
                            ...
                            <li key={type.id}>
                              <Link
                                ...
                                className={`text-xs text-slate-600 hover:text-[#66BB6A] hover:bg-green-50 transition-all duration-200 block py-1 px-2 rounded ${
                                  type.slug === "monel-400-pipestubes"
            ...
            <div className="flex-1 min-w-0 pt-4">
                ...
                <div className="relative p-8 sm:p-12 text-white">
                  <div className="max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                      {currentProduct?.title || "Monel 400 Pipes & Tubes"}
                    </h1>
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={pipesTubesImage}
                    alt={currentProduct?.title || "Monel 400 Pipes & Tubes"}
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  {currentProduct?.title || "Monel 400 Pipes & Tubes"} -
                  Manufacturers & Exporters of Monel 400 Pipes & Tubes, Monel
                  Alloy UNS N04400 Seamless Pipes & Seamless Tubes, Monel 400
                ...
                <p>
                  ...
                  is a well-known manufacturer & Exporters of Monel 400 Pipe &
                  Tubes. Monel 400 Pipe are usually used in industries such as
                  marine engineering, chemical processing, oil extraction,
                  aerospace, food processing, paper, machinery, and others.
                </p>
                <p>
                  Monel 400 is a nickel-copper alloy with excellent resistance
                  to corrosion in a wide range of media. It has good mechanical
                  properties and is particularly resistant to hydrofluoric acid,
                  sulfuric acid, and seawater. Even when exposed to high
                  temperature, Monel 400 retains its strength and is ductile at
                  low temperature.
                </p>
                <p>
                  The Monel 400 Pipes & Tubes are manufactured to sustain very
                ...
                <p>
                  ...
                  Monel 400 Seamless Pipes & Tubes are offered in customized
                  length sizes and shapes to our esteemed clients. Also referred
                  as UNS N04400, we offer these Monel Seamless Pipes & Tubes at
                  best possible rates in the market.
                </p>
                <p>
                  Our product includes tubes and pipes, Monel 400 Pipes, Monel
                  400 Tubes, Monel 400 Seamless Pipes & Tubes etc. These
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Monel 400 Seamless & Monel 400 Welded{" "}
                ...
                <div className="bg-green-50 rounded-2xl p-6 sm:p-8 border border-green-200">
                  ...
                  <p className="text-slate-600 mt-4 pt-4 border-t border-green-200 text-sm">
                    Monel 400 Pipes, Monel 400 Tubes, Monel Alloy Werkstoff
                    Nr.2.4360 Seamless Pipes & Tubes, Monel 400 Welded Pipes
                    Supplier, Monel Alloy 400 EFW / ERW Pipes & Tubes Exporter
                    in India.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  High Monel 400 Pipes & Tubes UNS N04400 Pipes{" "}
                  <br className="hidden sm:block" />
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">28.0 - 34.0</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">0.30 max</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">0.024 max</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR MONEL 400 PIPES, MONEL 400 TUBES,{" "}
                  <br className="hidden sm:block" />
                  <span className="text-[#66BB6A]">
                    MONEL 400 SEAMLESS PIPES, MONEL 400 WELDED TUBES
                  </span>
                </h2>
