...
import astmA6911_14CrImage from "../../assets/productsImage/pipes.jpg";

const ASTMA6911_14CRPage = () => {
  ...
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "astm-a691-1-1-4cr-pipes",
  );
  ...
  return (
    <>
      <Helmet>
        <title>
          ASTM A691 Gr.1 1/4 CR Alloy Steel Pipes | Sunlight Forge & Fitting
        </title>
        <meta
          name="description"
          content="High ASTM A691 Gr.1 1/4 CR Alloy Steel Pipes Manufacturer. Seamless & Welded Pipes. Export quality, best prices."
        />
      </Helmet>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
                            ...
                            <li key={type.id}>
                              <Link
                                ...
                                className={`text-xs text-slate-600 hover:text-[#66BB6A] hover:bg-green-50 transition-all duration-200 block py-1 px-2 rounded ${
                                  type.slug === "astm-a691-1-1-4cr-pipes"
            ...
            <div className="flex-1 min-w-0 pt-4">
                  ...
                  <div className="max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                      {currentProduct?.title ||
                        "Alloy Steel ASTM A691 Gr.1 1/4 CR Pipes"}
                    </h1>
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={astmA6911_14CrImage}
                    alt={
                      currentProduct?.title ||
                      "ASTM A691 Gr.1 1/4 CR Alloy Steel Pipe"
                    }
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                <p className="text-lg font-semibold text-[#4A148C]">
                  {currentProduct?.title ||
                    "Alloy Steel ASTM A691 / ASME SA691 Gr.1 1/4 CR Pipe"}
                </p>
                <p>
                  ...
                  and one of our known products include ASTM A691 GRADE 1 1/4 CR
                  Alloy Steel Pipe. The most useful properties of ASTM A691
                  GRADE 1 1/4 CR Alloy Steel Pipes, which make them efficient,
                ...
                <p>
                  We supply High precision ASTM A691 GRADE 1 1/4 CR Alloy Steel
                  Welded Pipe & high quality alloy grades pipes & tubes to Oil &
                  Gas, Nuclear And Power, Aerospace, Chemical Process, Medical,
                  High Purity and High Performance.
                </p>
                <p>
                  ASTM A691 GRADE 1 1/4 CR Alloy Steel Welded Pipe is High
                  Temperature Pipes and Tubes & available in form of Round
                  Pipes/Tubes, Square Pipes/Tubes, Rectangular Pipe/Tubes,
                  Coiled Tubes, "U" Shape, Pan Cake Coils and Hydraulic Tubes.
                </p>
                <p>
                  Alloy ASTM A691 Gr.1 1/4 CR High Pressure Pipe Exporter, Alloy
                  Steel Gr.1 1/4 CR Fabricated Pipe, ASME SA691 Gr.1 1/4 CR SAW
                  Pipe, Alloy Steel Gr.1 1/4 CR LSAW Pipe Manufacturer in India.
                </p>
              </div>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  ASTM A691 Alloy Steel Grade Gr.1 1/4 CR{" "}
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  ...
                  <span className="text-[#66BB6A]">Gr.1 1/4 CR Pipes</span>
                </h2>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR ALLOY A691 GR 1 1/4 PIPES, AS A691
                  PIPES, AS A691 GR 1 PIPE
                </h2>
...
export default ASTMA6911_14CRPage;
