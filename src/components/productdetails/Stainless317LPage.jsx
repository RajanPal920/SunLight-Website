...
const Stainless317LPage = () => {
  ...
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "317l-stainless-steel-pipestubes",
  );
  ...
  return (
    <>
      <Helmet>
        <title>
          Stainless Steel 317L Pipes & Tubes | Sunlight Forge & Fitting
        </title>
        <meta
          name="description"
          content="High Stainless Steel 317L Pipes & Tubes Manufacturer. SS UNS S31703 Seamless & Welded Pipes, Tubes. Export quality, best prices."
        />
      </Helmet>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
                            ...
                            <li key={type.id}>
                              <Link
                                ...
                                className={`text-xs text-slate-600 hover:text-[#66BB6A] hover:bg-green-50 transition-all duration-200 block py-1 px-2 rounded ${
                                  type.slug ===
                                  "317l-stainless-steel-pipestubes"
            ...
            <div className="flex-1 min-w-0 pt-4">
                  ...
                  <div className="max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                      {currentProduct?.title ||
                        "Stainless Steel 317L Pipes & Tubes"}
                    </h1>
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  SS 317L Tubes, 317L Stainless Steel Pipes, SS UNS S31703
                  Pipes, ASTM A312 Stainless Steel WRN 1.4438 Seamless Pipes &
                ...
                <p>
                  ...
                  are successfully ranked amongst the top manufacturer &
                  exporter of high quality ASTM 317L Stainless Steel Pipes &
                  Tubes. Our entire range complies with various national and
                  international standards. These 317L pipes & tubes are
                  available in SEAMLESS, ERW, WELDED and FABRICATED forms.
                </p>
                <p>
                  We have been supplying high quality Stainless Steel 317L Pipes
                ...
                <p>
                  SS 317L Pipes & SS 317L Tubes are more corrosion resistant
                  austenitic relative of 316L, due to the higher percent of
                  molybdenum. The additional moly gives Stainless Steel 317L
                  pipes & tubes improved resistance to chlorides and other
                  halides, particularly, and making it a strong candidate for
                  use in offshore applications or in processing applications
                  such as pulp and paper processes that contain corrosive
                  environments.
                </p>
                <p>
                  We stock and supply Stainless Steel 317L pipes & Tubes to meet
                  the diverse needs of customers in varied markets and
                  applications, seeks to be your preferred quality supplier of
                  Alloy 317L pipes and tubes.
                </p>
                <p>
                  Our product includes tubes and pipes, SS 317L Pipes, SS 317L
                  Tubes, Stainless 317L Seamless Pipes & Tubes etc. These
                  products are available at best possible prices which is
                  another important feature exhibited by our products range.
                </p>
                <p>
                  Stainless Steel 317L ERW Pipes, SS 317L Seamless Tubes, Steel
                  317L Welded Pipes, Stainless Steel 317L EFW Tubes, Stainless
                  ASTM A213 317L Seamless Pipes Manufacturer in India.
                </p>
              </div>

              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Stainless Steel 317L Seamless & Stainless Steel 317L Welded{" "}
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  317L Seamless / Welded / EFW / ERW Pipes & Tubes{" "}
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      <tr>
                        ...
                        <td className="px-4 py-2.5 text-sm">11.0 – 15.0</td>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Other Types of UNS S31703 Stainless Steel Pipes &{" "}
                  <span className="text-[#66BB6A]">
                    317L Stainless Steel Tubes
                  </span>
                </h2>
                  ...
                  {activeCategory.types?.map((type) => (
                    <div
                      ...
                      className={`bg-green-50 rounded-xl p-5 border ${
                        type.slug === "317l-stainless-steel-pipestubes"
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR SS 317L PIPES, STEEL 317L PIPES, SS
                  317L TUBES, <br className="hidden sm:block" />
                  <span className="text-[#66BB6A]">
                    STEEL 317L SEAMLESS PIPES & TUBES
                  </span>
                </h2>
...
export default Stainless317LPage;
