...
import buttweldImage from "../../assets/productsImage/buth.jpg";

const TitaniumButtweldFittingsPage = () => {
  ...
  const currentProduct = activeCategory?.types?.find(
    (type) => type.slug === "titanium-buttweld-fittings",
  );
  ...
  return (
    <>
      <Helmet>
        <title>
          Titanium Buttweld Pipe Fittings, Titanium Gr2 Seamless Fittings,
          Titanium Gr5 Welded Pipe Fittings Manufacturer, Titanium Buttweld Pipe
          Fittings, Titanium Elbow, Titanium Tee, Titanium Pipe Cross, Titanium
          Reducers, Titanium Short Radius Elbow Exporters in India.
        </title>
        <meta
          name="description"
          content="Titanium Buttweld Pipe Fittings, Titanium Gr2 Seamless Fittings, Titanium Gr5 Welded Pipe Fittings Manufacturer, Titanium Buttweld Pipe Fittings, Titanium Elbow, Titanium Tee, Titanium Pipe Cross, Titanium Reducers, Titanium Short Radius Elbow Exporters in India."
        />
      </Helmet>
                          ...
                          <li key={type.id}>
                            <Link
                              ...
                              className={`text-xs text-slate-600 hover:text-[#66BB6A] hover:bg-green-50 transition-all duration-200 block py-1 px-2 rounded ${
                                type.slug === "titanium-buttweld-fittings"
            ...
            <div className="flex-1 min-w-0 pt-4">
                ...
                <div className="relative p-8 sm:p-12 text-white">
                  <div className="max-w-2xl">
                    ...
                    <p className="mt-3 text-white/80 text-sm sm:text-base">
                      Titanium Gr2 Seamless Fittings, Titanium Gr5 Welded Pipe
                      Fittings Manufacturer, Titanium Buttweld Pipe Fittings,
                      Titanium Elbow, Titanium Tee, Titanium Pipe Cross,
                      Titanium Reducers, Titanium Short Radius Elbow Exporters
                      in India.
                    </p>
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={buttweldImage}
                    alt="Titanium Buttweld Fittings"
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  Titanium Welded Buttweld Fittings, Titanium Pipe Buttweld
                  Fittings, Titanium Seamless Pipe Buttweld Fittings
                </p>
                <p>
                  Neon Alloys is one of the pioneer supplier and dealer of
                  Titanium Butt Weld Pipe Fittings, which is a lightweight,
                  high-strength, corrosion-resistant metal. Titanium offers
                  exceptional resistance to a wide range of corrosive
                  environments including seawater, acids, and oxidizing
                  environments.
                </p>
                <p>
                  These Titanium Butt Weld Fittings are used extensively in
                ...
                <p>
                  These Titanium Pipe Fittings have exceptional resistance to a
                ...
                <p>
                  Titanium Butt Weld Pipe Fittings are widely used in various
              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                  {[
                    "Titanium Tee",
                    "Titanium Elbow",
                    "Titanium Reducing Tee",
                    "Titanium Coupling",
                    "Titanium Long & Short Stub Band",
                    "Titanium Reducer",
                    "Titanium Return Bends",
                    "Titanium Plug",
                    "Titanium Union",
                    "Titanium Pipe End Cap",
                    "Titanium Collar",
                    "Titanium Cross",
                  ].map((type, index) => (
                    <div
                ...
                <p className="text-center text-sm text-slate-600 mt-4">
                  Titanium Reducer, Titanium Pipe End Cap Supplier, Titanium
                  Stub end, Titanium Pipe Bends, Titanium Reducing Elbow,
                  Titanium Pipe Bends Exporter in India.
                </p>
              </div>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Titanium Butt weld Pipe Fittings available in standard and{" "}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <p>
                        ...
                        Titanium Gr2, Gr5, Gr7 (UNS R50400/R56400/R52400)
                      </p>
                      <p>
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      ...
                      <tr>
                        ...
                        <td className="px-4 py-2.5 text-sm">3.7164</td>
                        <td className="px-4 py-2.5 text-sm">TiAl6V4</td>
                        <td className="px-4 py-2.5 text-sm">TP 340</td>
                        <td className="px-4 py-2.5 text-sm">ВТ6</td>
                        <td className="px-4 py-2.5 text-sm">TA6V</td>
                        <td className="px-4 py-2.5 text-sm">-</td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                  {[
                    ...
                    "Titanium End Caps",
                    "Titanium 5D Elbow",
                    "Titanium 180° SR Return Bends",
                    "Titanium Long Radius Elbow",
                    "Titanium Eccentric Reducers",
                    "Titanium Reducing Crosses",
                    "Titanium Steel Elbows",
                    "Titanium Crosses",
                    "Titanium Couplings",
                    "Titanium Short Radius Elbow",
                    "Titanium ASME B16.9 Pipe Bends",
                    "Titanium 45° Elbows",
                    "Titanium Reducing Elbow",
                    "Titanium Piggable Bends",
                    "Titanium 180° LR Return Bends",
                    "Titanium Welded Fittings",
                    "Titanium Seamless Fittings",
                    "Titanium ASTM B363 Butt weld Fittings",
                    "Titanium Pipe Fittings",
                    "Titanium Pipe Fittings",
                    "Titanium Welded Pipe Fittings",
                  ].map((type, index) => (
                    <div
                      key={index}
                      className="bg-green-50 rounded-xl p-3 border border-green-200 hover:border-[#66BB6A] transition-colors text-center"
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR TITANIUM BUTT WELD PIPE FITTINGS,
                  TITANIUM PIPE FITTINGS, TITANIUM SEAMLESS FITTINGS, TITANIUM
...
export default TitaniumButtweldFittingsPage;
