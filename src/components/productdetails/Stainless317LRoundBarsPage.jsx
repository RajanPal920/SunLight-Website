...
const Stainless317LRoundBarsPage = () => {
  ...
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "317l-stainless-steel-roundbars",
  );
  ...
  return (
    <>
      <Helmet>
        <title>
          Stainless Steel 317L Round Bars & Rods Manufacturer, SS 317L Hex Bars
          Supplier, SS 317L Rods, Steel 317L Round Rods Exporter in India
        </title>
        <meta
          name="description"
          content="Manufacturer & Exporter of Stainless Steel 317L Round Bars & UNS S31703 Round Rods, SS 317L Bright Bars, Steel 317L Rods, 317L Hexagonal Bar Suppliers in India."
        />
      </Helmet>
                          ...
                          <li key={type.id}>
                            <Link
                              ...
                              className={`text-xs text-slate-600 hover:text-[#66BB6A] hover:bg-green-50 transition-all duration-200 block py-1 px-2 rounded ${
                                type.slug === "317l-stainless-steel-roundbars"
            ...
            <div className="flex-1 min-w-0 pt-4">
                ...
                <div className="relative p-8 sm:p-12 text-white">
                  <div className="max-w-2xl">
                    ...
                    <p className="mt-3 text-white/80 text-sm sm:text-base">
                      Manufacturer & Exporter of Stainless Steel 317L Round Bars
                      & UNS S31703 Round Rods, SS 317L Bright Bars, Steel 317L
                      Rods, 317L Hexagonal Bar Suppliers in India.
                    </p>
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={roundBarImage}
                    alt="Stainless Steel 317L Round Bars"
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  ...
                  317L Round Bar, which is manufactured using the supreme grade
                  raw material and is offered in varied forms in accordance with
                  the requirement of our clients. This range is available in
                  different dimensions as needed by the patrons. These products
                  are widely applicable in different fronts such as
                  pharmaceutical companies, pulp and paper mills, pharmaceutical
                  companies and fertilizer.
                </p>
                <p>
                  Stainless Steel 317L are molybdenum bearing austenitic
                  chromium nickel steel like Stainless Steel 316, aside from the
                  compound substance in 317L is to a degree higher.
                </p>
                <p>
                  It has a superior erosion resistance in exceptional
                  applications where it is coveted to diminish defilement to a
                  base. Stainless Steel 317L were produced principally to oppose
                  all the more viably the assault of sulfurous corrosive mixes.
                </p>
                <p>
                ...
                <p>
                  Stainless Steel 317L Round Rods Manufacturer, SS 317L Forged
                  Bar, Steel 317L Hex Bar, Stainless 317L Hollow Bar, WNR 1.4438
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  SS 317L Round Bars & Steel 317L Round Rods{" "}
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  ...
                  <span className="text-[#66BB6A]">317L Rods</span>
                </h2>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR SS 317L ROUND BARS, STEEL 317L BARS,
                  STAINLESS STEEL 317L RODS, STEEL 317L ROUND RODS, SS 317L RODS
                </h2>
...
export default Stainless317LRoundBarsPage;
