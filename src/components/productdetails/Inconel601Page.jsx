...
const Inconel601Page = () => {
  ...
  // Find the specific product type (Inconel 601)
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "inconel-601-pipestubes",
  );
  ...
  return (
    <>
      <Helmet>
        <title>Inconel 601 Pipes & Tubes | Sunlight Forge & Fitting</title>
        <meta
          name="description"
          content="High Inconel 601 Pipes & Tubes Manufacturer. UNS N06601 Seamless & Welded Pipes, Tubes. Export quality, best prices."
        />
      </Helmet>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 min-w-0 pt-4">
                ...
                <div className="relative p-8 sm:p-12 text-white">
                  <div className="max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                      {currentProduct?.title || "Inconel 601 Pipes & Tubes"}
                    </h1>
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  {currentProduct?.title || "Inconel 601 Pipes & Tubes"} -
                  Manufacturers & Exporters of Inconel 601 Pipes & Tubes,
                  Inconel Alloy UNS N06601 Seamless Pipes & Seamless Tubes,
                  Inconel 601 Welded Pipes & Welded Tubes in India.
                </p>
                <p>
                  <span className="font-semibold text-[#4A148C]">
                    {contactDetails.company}
                  </span>{" "}
                  is a well-known manufacturer & Exporters of Inconel 601 Pipe &
                  Tubes. Inconel 601 Pipe are usually used in industries such as
                  chemical processing, aerospace, marine engineering, nuclear
                  engineering, food processing, paper, machinery, and others.
                </p>
                <p>
                  Inconel 601 is a nickel-chromium alloy with excellent
                  resistance to high-temperature oxidation and corrosion. It has
                  good mechanical properties and excellent resistance to
                  chloride-ion stress-corrosion cracking.
                </p>
                <p>
                  The Inconel 601 Pipes & Tubes are manufactured to sustain very
                ...
                <p>
                  ...
                  Inconel 601 Seamless Pipes & Tubes are offered in customized
                  length sizes and shapes to our esteemed clients. Also referred
                  as UNS N06601, we offer these Inconel Seamless Pipes & Tubes
                  at best possible rates in the market.
                </p>
                <p>
                  Our product includes tubes and pipes, Inconel 601 Pipes,
                  Inconel 601 Tubes, Inconel 601 Seamless Pipes & Tubes etc.
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Inconel 601 Seamless & Inconel 601 Welded{" "}
                ...
                <div className="bg-green-50 rounded-2xl p-6 sm:p-8 border border-green-200">
                  ...
                  <p className="text-slate-600 mt-4 pt-4 border-t border-green-200 text-sm">
                    Inconel 601 Pipes, Inconel 601 Tubes, Inconel Alloy
                    Werkstoff Nr.2.4851 Seamless Pipes & Tubes, Inconel 601
                    Welded Pipes Supplier, Inconel Alloy 601 EFW / ERW Pipes &
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  High Inconel 601 Pipes & Tubes UNS N06601 Pipes{" "}
                  <br className="hidden sm:block" />
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">58.0 - 63.0</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Cr</td>
                        <td className="px-6 py-2.5 text-sm">21.0 - 25.0</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Al</td>
                        <td className="px-6 py-2.5 text-sm">1.0 - 1.7</td>
                      </tr>
                      <tr>
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      <tr>
                        ...
                        <td className="px-4 py-2.5 text-sm">NW 6601</td>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR INCONEL 601 PIPES, INCONEL 601 TUBES,{" "}
                  <br className="hidden sm:block" />
                  <span className="text-[#66BB6A]">
                    INCONEL 601 SEAMLESS PIPES, INCONEL 601 WELDED TUBES
                  </span>
                </h2>
