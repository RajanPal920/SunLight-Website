...
import pipesTubesImage from "../../assets/productsImage/cu1.jpg";
...
const CuNi70Page = () => {
  ...
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "cu-ni-70-pipestubes",
  );
  ...
  return (
    <>
      <Helmet>
        <title>Cu-Ni 70/30 Pipes & Tubes | Sunlight Forge & Fitting</title>
        <meta
          name="description"
          content="High Cu-Ni 70/30 Pipes & Tubes Manufacturer. UNS C71500 Seamless & Welded Pipes, Tubes. Export quality, best prices."
        />
      </Helmet>
            ...
            <div className="flex-1 min-w-0 pt-4">
                ...
                <div className="relative p-8 sm:p-12 text-white">
                  <div className="max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                      {currentProduct?.title || "Cu-Ni 70/30 Pipes & Tubes"}
                    </h1>
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={pipesTubesImage}
                    alt={currentProduct?.title || "Cu-Ni 70/30 Pipes & Tubes"}
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  {currentProduct?.title || "Cu-Ni 70/30 Pipes & Tubes"} -
                  Manufacturers & Exporters of Cu-Ni 70/30 Pipes & Tubes, Copper
                  Nickel UNS C71500 Seamless Pipes & Seamless Tubes, Cu-Ni 70/30
                ...
                <p>
                  ...
                  is a well-known manufacturer & Exporters of Cu-Ni 70/30 Pipe &
                  Tubes. Cu-Ni 70/30 Pipe are usually used in industries such as
                  marine engineering, chemical processing, oil extraction, food
                  processing, paper, machinery, and others.
                </p>
                <p>
                  Cu-Ni 70/30 is a copper-nickel alloy with excellent resistance
                  to corrosion, particularly in seawater and marine
                  environments. It has good mechanical properties and excellent
                  resistance to biofouling.
                </p>
                <p>
                  The Cu-Ni 70/30 Pipes & Tubes are manufactured to sustain very
                ...
                <p>
                  ...
                  Cu-Ni 70/30 Seamless Pipes & Tubes are offered in customized
                  length sizes and shapes to our esteemed clients. Also referred
                  as UNS C71500, we offer these Cu-Ni Seamless Pipes & Tubes at
                  best possible rates in the market.
                </p>
                <p>
                  Our product includes tubes and pipes, Cu-Ni 70/30 Pipes, Cu-Ni
                  70/30 Tubes, Cu-Ni 70/30 Seamless Pipes & Tubes etc. These
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Cu-Ni 70/30 Seamless & Cu-Ni 70/30 Welded{" "}
                ...
                <div className="bg-green-50 rounded-2xl p-6 sm:p-8 border border-green-200">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      <p>
                        <strong className="text-[#4A148C]">Grade:</strong> Cu-Ni
                        70/30 (UNS C71500)
                      </p>
                      <p>
                  ...
                  <p className="text-slate-600 mt-4 pt-4 border-t border-green-200 text-sm">
                    Cu-Ni 70/30 Pipes, Cu-Ni 70/30 Tubes, Copper Nickel
                    Werkstoff Nr.2.0882 Seamless Pipes & Tubes, Cu-Ni 70/30
                    Welded Pipes Supplier, Cu-Ni 70/30 EFW / ERW Pipes & Tubes
                    Exporter in India.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  High Cu-Ni 70/30 Pipes & Tubes UNS C71500 Pipes{" "}
                  <br className="hidden sm:block" />
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">29.0 - 33.0</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Fe</td>
                        <td className="px-6 py-2.5 text-sm">0.4 - 1.0</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">0.05 max</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Zn</td>
                        <td className="px-6 py-2.5 text-sm">1.0 max</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Pb</td>
                        <td className="px-6 py-2.5 text-sm">0.05 max</td>
                      </tr>
                      <tr>
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      <tr>
                        ...
                        <td className="px-4 py-2.5 text-sm">C71500</td>
                        <td className="px-4 py-2.5 text-sm">2.0882</td>
                        <td className="px-4 py-2.5 text-sm">CuNi30Fe</td>
                        <td className="px-4 py-2.5 text-sm">CN 107</td>
                        <td className="px-4 py-2.5 text-sm">НП-2</td>
                        <td className="px-4 py-2.5 text-sm">NW 7150</td>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR CU-NI 70/30 PIPES, CU-NI 70/30 TUBES,{" "}
                  <br className="hidden sm:block" />
                  <span className="text-[#66BB6A]">
                    CU-NI 70/30 SEAMLESS PIPES, CU-NI 70/30 WELDED TUBES
                  </span>
                </h2>
