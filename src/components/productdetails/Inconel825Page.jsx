...
const Inconel825Page = () => {
  ...
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "inconel-825-pipestubes",
  );
  ...
  return (
    <>
      <Helmet>
        <title>Inconel 825 Pipes & Tubes | Sunlight Forge & Fitting</title>
        <meta
          name="description"
          content="High Inconel 825 Pipes & Tubes Manufacturer. UNS N08825 Seamless & Welded Pipes, Tubes. Export quality, best prices."
        />
      </Helmet>
                            ...
                            <li key={type.id}>
                              <Link
                                ...
                                className={`text-xs text-slate-600 hover:text-[#66BB6A] hover:bg-green-50 transition-all duration-200 block py-1 px-2 rounded ${
                                  type.slug === "inconel-825-pipestubes"
            ...
            <div className="flex-1 min-w-0 pt-4">
                ...
                <div className="relative p-8 sm:p-12 text-white">
                  <div className="max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                      {currentProduct?.title || "Inconel 825 Pipes & Tubes"}
                    </h1>
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={pipesTubesImage}
                    alt={currentProduct?.title || "Inconel 825 Pipes & Tubes"}
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  {currentProduct?.title || "Inconel 825 Pipes & Tubes"} -
                  Manufacturers & Exporters of Inconel 825 Pipes & Tubes,
                  Inconel Alloy UNS N08825 Seamless Pipes & Seamless Tubes,
                  Inconel 825 Welded Pipes & Welded Tubes in India.
                </p>
                <p>
                  <span className="font-semibold text-[#4A148C]">
                    {contactDetails.company}
                  </span>{" "}
                  is a well-known manufacturer & Exporters of Inconel 825 Pipe &
                  Tubes. Inconel 825 Pipe are usually used in industries such as
                ...
                <p>
                  ...
                  molybdenum, copper, and titanium. It has excellent resistance
                  to corrosion and oxidation at high temperatures and is
                  particularly resistant to sulfuric and phosphoric acids.
                </p>
                <p>
                  The Inconel 825 Pipes & Tubes are manufactured to sustain very
                ...
                <p>
                  ...
                  Inconel 825 Seamless Pipes & Tubes are offered in customized
                  length sizes and shapes to our esteemed clients. Also referred
                  as UNS N08825, we offer these Inconel Seamless Pipes & Tubes
                  at best possible rates in the market.
                </p>
                <p>
                  Our product includes tubes and pipes, Inconel 825 Pipes,
                  Inconel 825 Tubes, Inconel 825 Seamless Pipes & Tubes etc.
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Inconel 825 Seamless & Inconel 825 Welded{" "}
                ...
                <div className="bg-green-50 rounded-2xl p-6 sm:p-8 border border-green-200">
                  ...
                  <p className="text-slate-600 mt-4 pt-4 border-t border-green-200 text-sm">
                    Inconel 825 Pipes, Inconel 825 Tubes, Inconel Alloy
                    Werkstoff Nr.2.4858 Seamless Pipes & Tubes, Inconel 825
                    Welded Pipes Supplier, Inconel Alloy 825 EFW / ERW Pipes &
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  High Inconel 825 Pipes & Tubes UNS N08825 Pipes{" "}
                  <br className="hidden sm:block" />
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">38.0 - 46.0</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Fe</td>
                        <td className="px-6 py-2.5 text-sm">22.0 min</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Cr</td>
                        <td className="px-6 py-2.5 text-sm">19.5 - 23.5</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Mo</td>
                        <td className="px-6 py-2.5 text-sm">2.5 - 3.5</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Cu</td>
                        <td className="px-6 py-2.5 text-sm">1.5 - 3.0</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Ti</td>
                        <td className="px-6 py-2.5 text-sm">0.6 - 1.2</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">0.03 max</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      <tr>
                        ...
                        <td className="px-4 py-2.5 text-sm">NW 8825</td>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR INCONEL 825 PIPES, INCONEL 825 TUBES,{" "}
                  <br className="hidden sm:block" />
                  <span className="text-[#66BB6A]">
                    INCONEL 825 SEAMLESS PIPES, INCONEL 825 WELDED TUBES
                  </span>
                </h2>
