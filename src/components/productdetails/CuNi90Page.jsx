...
import pipesTubesImage from "../../assets/productsImage/cu.jpg";
...
const CuNi90Page = () => {
  ...
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "cu-ni-90-pipestubes",
  );
  ...
  return (
    <>
      <Helmet>
        <title>Cu-Ni 90/10 Pipes & Tubes | Sunlight Forge & Fitting</title>
        <meta
          name="description"
          content="High Cu-Ni 90/10 Pipes & Tubes Manufacturer. UNS C70600 Seamless & Welded Pipes, Tubes. Export quality, best prices."
        />
      </Helmet>
            ...
            <div className="flex-1 min-w-0 pt-4">
                ...
                <div className="relative p-8 sm:p-12 text-white">
                  <div className="max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                      {currentProduct?.title || "Cu-Ni 90/10 Pipes & Tubes"}
                    </h1>
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={pipesTubesImage}
                    alt={currentProduct?.title || "Cu-Ni 90/10 Pipes & Tubes"}
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  {currentProduct?.title || "Cu-Ni 90/10 Pipes & Tubes"} -
                  Manufacturers & Exporters of Cu-Ni 90/10 Pipes & Tubes, Copper
                  Nickel UNS C70600 Seamless Pipes & Seamless Tubes, Cu-Ni 90/10
                ...
                <p>
                  ...
                  is a well-known manufacturer & Exporters of Cu-Ni 90/10 Pipe &
                  Tubes. Cu-Ni 90/10 Pipe are usually used in industries such as
                  marine engineering, chemical processing, oil extraction, food
                  processing, paper, machinery, and others.
                </p>
                <p>
                  Cu-Ni 90/10 is a copper-nickel alloy with excellent resistance
                ...
                <p>
                  The Cu-Ni 90/10 Pipes & Tubes are manufactured to sustain very
                ...
                <p>
                  ...
                  Cu-Ni 90/10 Seamless Pipes & Tubes are offered in customized
                  length sizes and shapes to our esteemed clients. Also referred
                  as UNS C70600, we offer these Cu-Ni Seamless Pipes & Tubes at
                  best possible rates in the market.
                </p>
                <p>
                  Our product includes tubes and pipes, Cu-Ni 90/10 Pipes, Cu-Ni
                  90/10 Tubes, Cu-Ni 90/10 Seamless Pipes & Tubes etc. These
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Cu-Ni 90/10 Seamless & Cu-Ni 90/10 Welded{" "}
                ...
                <div className="bg-green-50 rounded-2xl p-6 sm:p-8 border border-green-200">
                  ...
                  <p className="text-slate-600 mt-4 pt-4 border-t border-green-200 text-sm">
                    Cu-Ni 90/10 Pipes, Cu-Ni 90/10 Tubes, Copper Nickel
                    Werkstoff Nr.2.0872 Seamless Pipes & Tubes, Cu-Ni 90/10
                    Welded Pipes Supplier, Cu-Ni 90/10 EFW / ERW Pipes & Tubes
                    Exporter in India.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  High Cu-Ni 90/10 Pipes & Tubes UNS C70600 Pipes{" "}
                  <br className="hidden sm:block" />
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">9.0 - 11.0</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Fe</td>
                        <td className="px-6 py-2.5 text-sm">1.0 - 1.8</td>
                      </tr>
                      <tr>
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      <tr>
                        ...
                        <td className="px-4 py-2.5 text-sm">C70600</td>
                        <td className="px-4 py-2.5 text-sm">2.0872</td>
                        <td className="px-4 py-2.5 text-sm">CuNi10Fe</td>
                        <td className="px-4 py-2.5 text-sm">CN 102</td>
                        <td className="px-4 py-2.5 text-sm">НП-2</td>
                        <td className="px-4 py-2.5 text-sm">NW 7060</td>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR CU-NI 90/10 PIPES, CU-NI 90/10 TUBES,{" "}
                  <br className="hidden sm:block" />
                  <span className="text-[#66BB6A]">
                    CU-NI 90/10 SEAMLESS PIPES, CU-NI 90/10 WELDED TUBES
                  </span>
                </h2>
