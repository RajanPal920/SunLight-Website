// src/pages/products/NickelAlloy200RoundBarsPage.jsx
...
const NickelAlloy200RoundBarsPage = () => {
  ...
  // Find the specific product (Nickel Alloy 200 Round Bars)
  const currentProduct = activeCategory?.types?.find(
    (type) => type.slug === "nickel-alloy-200-roundbars",
  );
  ...
  return (
    <>
      <Helmet>
        <title>
          Nickel Alloy 200 Round Bars & Rods | Sunlight Forge & Fitting
        </title>
        <meta
          name="description"
          content="High Nickel Alloy 200 Round Bars & Rods Manufacturer. Nickel Alloy UNS N02200 Hex Bars, Square Bars & Round Rods Supplier in India."
        />
      </Helmet>
                          ...
                          <li key={type.id}>
                            <Link
                              ...
                              className={`text-xs text-slate-600 hover:text-[#66BB6A] hover:bg-green-50 transition-all duration-200 block py-1 px-2 rounded ${
                                type.slug === "nickel-alloy-200-roundbars"
            ...
            <div className="flex-1 min-w-0 pt-4">
                  ...
                  <div className="max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                      {currentProduct?.title ||
                        "Nickel Alloy 200 Round Bars & Rods"}
                    </h1>
                    <p className="mt-3 text-white/80 text-sm sm:text-base">
                      {activeCategory?.description ||
                        "High-quality nickel alloy round bars and rods for demanding applications."}
                    </p>
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={roundBarImage}
                    alt={currentProduct?.title || "Nickel Alloy 200 Round Bars"}
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                <p className="text-lg font-semibold text-[#4A148C]">
                  {currentProduct?.title ||
                    "High Nickel Alloy 200 Round Bars & Rods"}
                </p>
                <p>
                  Manufacturer & Exporter of High Nickel Alloy 200 Round Bars &
                  Rods, Nickel Alloy UNS N02200 Hex Bars, Nickel 200 Square Bars
                  & Nickel Alloy 200 Round Rods Supplier in India.
                </p>
                <p>
                  As per the variegated needs and necessities of our customers,
                  we manufacture & export a world class collection of Nickel
                  Alloy 200 Round Bars in form of Round, Square, Hex (A/F),
                  Bush, Rectangle, Flat, and Wire Mesh.
                </p>
                <p>
                  Being one of the major provider, we are delivering engineered
                  developed High Nickel Alloy Round Bars, which are broadly
                  utilized by our buyers and demanded across the world for its
                  highly long lasting and effective performances.
                </p>
                <p>
                  Our offered range of bars is manufactured making use of
                  quality nickel alloys and these alloy 200 round bars are
                  widely appreciated and used in various industrial applications
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  {currentProduct?.title || "Nickel Alloy 200 Round Bars"}{" "}
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Other Types of{" "}
                  <span className="text-[#66BB6A]">Round Bars & Rods</span>
                </h2>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR NICKEL ALLOY 200 ROUND BARS & RODS
                </h2>
...
export default NickelAlloy200RoundBarsPage;
