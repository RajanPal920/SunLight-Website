...
const Alloy20Page = () => {
  ...
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "alloy-20-pipestubes",
  );
  ...
  return (
    <>
      <Helmet>
        <title>Alloy 20 Pipes & Tubes | Sunlight Forge & Fitting</title>
        <meta
          name="description"
          content="High Alloy 20 Pipes & Tubes Manufacturer. UNS N08020 Seamless & Welded Pipes, Tubes. Export quality, best prices."
        />
      </Helmet>
            ...
            <div className="flex-1 min-w-0 pt-4">
                ...
                <div className="relative p-8 sm:p-12 text-white">
                  <div className="max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                      {currentProduct?.title || "Alloy 20 Pipes & Tubes"}
                    </h1>
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={pipesTubesImage}
                    alt={currentProduct?.title || "Alloy 20 Pipes & Tubes"}
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  {currentProduct?.title || "Alloy 20 Pipes & Tubes"} -
                  Manufacturers & Exporters of Alloy 20 Pipes & Tubes, Alloy 20
                  UNS N08020 Seamless Pipes & Seamless Tubes, Alloy 20 Welded
                  Pipes & Welded Tubes in India.
                </p>
                <p>
                  <span className="font-semibold text-[#4A148C]">
                    {contactDetails.company}
                  </span>{" "}
                  is a well-known manufacturer & Exporters of Alloy 20 Pipe &
                  Tubes. Alloy 20 Pipe are usually used in industries such as
                  chemical processing, pharmaceutical, food processing, paper,
                  machinery, and others.
                </p>
                <p>
                  Alloy 20 is a nickel-iron-chromium alloy with additions of
                  molybdenum, copper, and columbium. It has excellent resistance
                  to corrosion, particularly in sulfuric and phosphoric acids,
                  and is also resistant to chloride-ion stress-corrosion
                  cracking.
                </p>
                <p>
                  The Alloy 20 Pipes & Tubes are manufactured to sustain very
                ...
                <p>
                  ...
                  Alloy 20 Seamless Pipes & Tubes are offered in customized
                  length sizes and shapes to our esteemed clients. Also referred
                  as UNS N08020, we offer these Alloy 20 Seamless Pipes & Tubes
                  at best possible rates in the market.
                </p>
                <p>
                  Our product includes tubes and pipes, Alloy 20 Pipes, Alloy 20
                  Tubes, Alloy 20 Seamless Pipes & Tubes etc. These products are
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Alloy 20 Seamless & Alloy 20 Welded{" "}
                ...
                <div className="bg-green-50 rounded-2xl p-6 sm:p-8 border border-green-200">
                  ...
                  <p className="text-slate-600 mt-4 pt-4 border-t border-green-200 text-sm">
                    Alloy 20 Pipes, Alloy 20 Tubes, Alloy 20 Werkstoff Nr.2.4660
                    Seamless Pipes & Tubes, Alloy 20 Welded Pipes Supplier,
                    Alloy 20 EFW / ERW Pipes & Tubes Exporter in India.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  High Alloy 20 Pipes & Tubes UNS N08020 Pipes{" "}
                  <br className="hidden sm:block" />
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">32.0 - 38.0</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Cr</td>
                        <td className="px-6 py-2.5 text-sm">19.0 - 21.0</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">2.0 - 3.0</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Cu</td>
                        <td className="px-6 py-2.5 text-sm">3.0 - 4.0</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Nb</td>
                        <td className="px-6 py-2.5 text-sm">0.5 - 1.0</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">0.07 max</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">0.035 max</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      <tr>
                        ...
                        <td className="px-4 py-2.5 text-sm">NW 8020</td>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR ALLOY 20 PIPES, ALLOY 20 TUBES,{" "}
                  <br className="hidden sm:block" />
                  <span className="text-[#66BB6A]">
                    ALLOY 20 SEAMLESS PIPES, ALLOY 20 WELDED TUBES
                  </span>
                </h2>
