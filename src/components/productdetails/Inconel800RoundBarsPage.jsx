...
const Inconel800RoundBarsPage = () => {
  ...
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "inconel-800-roundbars",
  );
            ...
            <div className="flex-1 min-w-0 pt-4">
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={roundBarImage}
                    alt={currentProduct?.title || "Inconel 800 Round Bars"}
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  ...
                  highly long lasting and effective performances. These bars are
                  crevice corrosion, stress corrosion cracking, and resistive to
                  adverse conditions. We ensure the best quality products to our
                  esteemed buyers with advanced features and durability.
                </p>
                <p>
                  This Inconel 800 round bars find extensive application in
                  furnace muffles, electronic components, heat exchangers, heat
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Inconel Alloy 800 Round Bars & Alloy 800 Round Rods{" "}
...
export default Inconel800RoundBarsPage;
