...
const Stainless316HRoundBarsPage = () => {
  ...
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "316h-stainless-steel-roundbars",
  );
  ...
  return (
    <>
      <Helmet>
        <title>
          Stainless Steel 316H Round Bars & Rods Manufacturer, SS 316H Hex Bars
          Supplier, SS 316H Rods, Steel 316H Round Rods Exporter in India
        </title>
        <meta
          name="description"
          content="Manufacturer & Exporter of Stainless Steel 316H Round Bars & UNS S31609 Round Rods, SS 316H Bright Bars, Steel 316H Rods, 316H Hexagonal Bar Suppliers in India."
        />
      </Helmet>
                          ...
                          <li key={type.id}>
                            <Link
                              ...
                              className={`text-xs text-slate-600 hover:text-[#66BB6A] hover:bg-green-50 transition-all duration-200 block py-1 px-2 rounded ${
                                type.slug === "316h-stainless-steel-roundbars"
            ...
            <div className="flex-1 min-w-0 pt-4">
                ...
                <div className="relative p-8 sm:p-12 text-white">
                  <div className="max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                      Stainless Steel 316H Round Bars & Rods
                    </h1>
                    <p className="mt-3 text-white/80 text-sm sm:text-base">
                      Manufacturer & Exporter of Stainless Steel 316H Round Bars
                      & UNS S31609 Round Rods, SS 316H Bright Bars, Steel 316H
                      Rods, 316H Hexagonal Bar Suppliers in India.
                    </p>
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={roundBarImage}
                    alt="Stainless Steel 316H Round Bars"
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  ...
                  quality of SS 316H Round Bar to our valuable customers.
                </p>
                <p>
                  These 316h bars are known for their long lives, excellent
                  quality, optimum performance, economical rates, dimensional
                  accuracy, durability, corrosion resistance and excellent
                  finish. The entire range is manufactured using premium quality
                  raw material and advanced technology. SS 316H Round Bar are
                  regularly tested on different quality standards from time to
                  time.
                </p>
                <p>
                  These 316H round bars are appreciated by our clients for their
                  high strength, corrosion resistance and durability. Moreover,
                  we also make sure that our range meets the international
                  quality standards.
                </p>
                <p>
                  Also known as UNS S31609 Bars, these 316H Stainless Steel bars
                ...
                <p>
                  Stainless Steel 316H Round Rods Manufacturer, SS 316H Forged
                  Bar, Steel 316H Hex Bar, Stainless 316H Hollow Bar, UNS S31609
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  SS 316H Round Bars & Steel 316H Round Rods{" "}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      <p>
                        ...
                        Stainless Steel 316H (UNS S31609)
                      </p>
                      <p>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Other Types of Stainless Steel 316H Round Bars &{" "}
                  <span className="text-[#66BB6A]">316H Rods</span>
                </h2>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR SS 316H ROUND BARS, STEEL 316H BARS,
                  STAINLESS STEEL 316H RODS, STEEL 316H ROUND RODS, SS 316H RODS
                </h2>
...
export default Stainless316HRoundBarsPage;
