...
const Inconel825RoundBarsPage = () => {
  ...
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "inconel-825-roundbars",
  );
  ...
  return (
    <>
      <Helmet>
        <title>
          Inconel Alloy 825 Round Bars & Rods | Sunlight Forge & Fitting
        </title>
        <meta
          name="description"
          content="High Inconel Alloy 825 Round Bars & Rods Manufacturer. UNS N08825 Hex Bars, Square Bars & Round Rods Supplier in India."
        />
      </Helmet>
                          ...
                          <li key={type.id}>
                            <Link
                              ...
                              className={`text-xs text-slate-600 hover:text-[#66BB6A] hover:bg-green-50 transition-all duration-200 block py-1 px-2 rounded ${
                                type.slug === "inconel-825-roundbars"
            ...
            <div className="flex-1 min-w-0 pt-4">
                  ...
                  <div className="max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                      {currentProduct?.title ||
                        "Inconel Alloy 825 Round Bars & Rods"}
                    </h1>
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={roundBarImage}
                    alt={currentProduct?.title || "Inconel 825 Round Bars"}
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  {currentProduct?.title ||
                    "Inconel Alloy 825 Round Bars & Rods"}{" "}
                  - Manufacturers & Exporters of Inconel Alloy 825 Round Bars &
                  Rods, Alloy UNS N08825 Hex Bars, Incoloy 825 Square Bars &
                  Alloy 825 Round Rods Supplier in India.
                </p>
                <p>
                  <span className="font-semibold text-[#4A148C]">
                    {contactDetails.company}
                  </span>{" "}
                  is a recognized company Manufacturing and Exporting a huge
                  assortment of Inconel 825 Round Bar to our respected clients.
                  Our offered round bar is amazingly processed using only finest
                  nickel and latest machinery in accordance with market
                  standards.
                </p>
                <p>
                  Inconel rods have excellent mechanical properties and provide
                  good resistance to oxidation. The offered Inconel 825 round
                  bars are severely inspected on quality parameters by our
                  quality department.
                </p>
                <p>
                  Inconel 825 bars manufactured from quality raw material, these
                ...
                <p>
                  Our Inconel 825 Round bars & rods are used extensively in
                  various industrial applications industries ranging from basic
                ...
                <p>
                  Inconel Alloy 825 Rods, Inconel Werkstoff Nr 2.4858 Round
                  Bars, Inconel 825 Round Rods, Inconel Alloy 825 Hexagonal
                  Bars, Alloy 825 Bright Bars Supplier & Incoloy 825 Bars
                  Exporter in India.
                </p>
              </div>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Inconel Alloy 825 Round Bars & Alloy 825 Round Rods{" "}
                ...
                <div className="bg-green-50 rounded-2xl p-6 sm:p-8 border border-green-200">
                  ...
                  <p className="text-slate-600 mt-4 pt-4 border-t border-green-200 text-sm">
                    Inconel 825 Round Bars, Inconel 825 Rods, Inconel Alloy
                    Werkstoff Nr.2.4858 Round Bars & Rods, Inconel 825 Hex Bars,
                    Inconel 825 Square Bars Supplier, Inconel Alloy 825 EFW /
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Other Types of ASTM A166 Inconel Alloy 825 Round Bars &{" "}
                  <span className="text-[#66BB6A]">Inconel 825 Rods</span>
                </h2>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR ALLOY 825 ROUND BARS, INCONEL 825
                  RODS, ALLOY 825 BARS, ALLOY 825 ROUND RODS
                </h2>
...
export default Inconel825RoundBarsPage;
