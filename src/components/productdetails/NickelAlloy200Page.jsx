...
import pipesTubesImage from "../../assets/productsImage/200pipes.jpg";

const NickelAlloy200Page = () => {
  ...
  // Find the specific product type (Nickel Alloy 200)
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "nickel-alloy-200-pipestubes",
  );
  ...
  return (
    <>
      <Helmet>
        <title>Nickel Alloy 200 Pipes & Tubes | Sunlight Forge & Fitting</title>
        <meta
          name="description"
          content="High Nickel Alloy 200 Pipes & Tubes Manufacturer. UNS N02200 Seamless & Welded Pipes, Tubes. Export quality, best prices."
        />
      </Helmet>
            ...
            <div className="flex-1 min-w-0 pt-4">
                ...
                <div className="relative p-8 sm:p-12 text-white">
                  <div className="max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                      {currentProduct?.title || activeCategory.title}
                    </h1>
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={pipesTubesImage}
                    alt={currentProduct?.title || activeCategory.title}
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  ...
                  is a well-known manufacturer & Exporters of{" "}
                  {currentProduct?.title || activeCategory.title}. These
                  products are usually used in industries such as construction,
                  oil extraction, medicine, food, paper, machinery, chemicals,
                  food containers and others.
                </p>
                <p>
                  {activeCategory.title} are manufactured to sustain very high
                  pressure and product warranty. The main reason being we have
                  an excellent warehousing and storage facilities for both
                  finished and semi finish goods.
                </p>
                <p>
                  Designed as per international and national standards, these
                  products are offered in customized length sizes and shapes to
                  our esteemed clients. We offer these at best possible rates in
                  the market.
                </p>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="bg-green-50 rounded-2xl p-6 sm:p-8 border border-green-200">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      <p>
                        <strong className="text-[#4A148C]">Range:</strong>{" "}
                        {pipesTubes.specifications.range}
                      </p>
                      <p>
                        <strong className="text-[#4A148C]">Form:</strong>{" "}
                        {pipesTubes.specifications.form}
                      </p>
                    </div>
                    <div>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR {activeCategory.title.toUpperCase()}
                </h2>
...
export default NickelAlloy200Page;
