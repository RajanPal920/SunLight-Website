...
const Inconel625Page = () => {
  ...
  // Find the specific product type (Inconel 625)
  const currentProduct = activeCategory.types?.find(
    (type) => type.slug === "inconel-625-pipestubes",
  );
  ...
  return (
    <>
      <Helmet>
        <title>Inconel 625 Pipes & Tubes | Sunlight Forge & Fitting</title>
        <meta
          name="description"
          content="High Inconel 625 Pipes & Tubes Manufacturer. UNS N06625 Seamless & Welded Pipes, Tubes. Export quality, best prices."
        />
      </Helmet>
                            ...
                            <li key={type.id}>
                              <Link
                                ...
                                className={`text-xs text-slate-600 hover:text-[#66BB6A] hover:bg-green-50 transition-all duration-200 block py-1 px-2 rounded ${
                                  type.slug === "inconel-625-pipestubes"
            ...
            <div className="flex-1 min-w-0 pt-4">
                ...
                <div className="relative p-8 sm:p-12 text-white">
                  <div className="max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                      {currentProduct?.title || "Inconel 625 Pipes & Tubes"}
                    </h1>
              ...
              <div className="mb-8 bg-white rounded-2xl p-4 border border-slate-200">
                <div className="flex justify-center">
                  <img
                    src={pipesTubesImage}
                    alt={currentProduct?.title || "Inconel 625 Pipes & Tubes"}
              ...
              <div className="space-y-4 text-slate-700 leading-relaxed bg-white rounded-2xl p-6 sm:p-8 border border-slate-200">
                ...
                <p>
                  {currentProduct?.title || "Inconel 625 Pipes & Tubes"} -
                  Manufacturers & Exporters of Inconel 625 Pipes & Tubes,
                  Inconel Alloy UNS N06625 Seamless Pipes & Seamless Tubes,
                  Inconel 625 Welded Pipes & Welded Tubes in India.
                </p>
                <p>
                  <span className="font-semibold text-[#4A148C]">
                    {contactDetails.company}
                  </span>{" "}
                  is a well-known manufacturer & Exporters of Inconel 625 Pipe &
                  Tubes. Inconel 625 Pipe are usually used in industries such as
                ...
                <p>
                  ...
                  excellent resistance to corrosion and oxidation at high
                  temperatures. It has good mechanical properties and excellent
                  resistance to chloride-ion stress-corrosion cracking.
                </p>
                <p>
                  The Inconel 625 Pipes & Tubes are manufactured to sustain very
                ...
                <p>
                  ...
                  Inconel 625 Seamless Pipes & Tubes are offered in customized
                  length sizes and shapes to our esteemed clients. Also referred
                  as UNS N06625, we offer these Inconel Seamless Pipes & Tubes
                  at best possible rates in the market.
                </p>
                <p>
                  Our product includes tubes and pipes, Inconel 625 Pipes,
                  Inconel 625 Tubes, Inconel 625 Seamless Pipes & Tubes etc.
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  Inconel 625 Seamless & Inconel 625 Welded{" "}
                ...
                <div className="bg-green-50 rounded-2xl p-6 sm:p-8 border border-green-200">
                  ...
                  <p className="text-slate-600 mt-4 pt-4 border-t border-green-200 text-sm">
                    Inconel 625 Pipes, Inconel 625 Tubes, Inconel Alloy
                    Werkstoff Nr.2.4856 Seamless Pipes & Tubes, Inconel 625
                    Welded Pipes Supplier, Inconel Alloy 625 EFW / ERW Pipes &
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  High Inconel 625 Pipes & Tubes UNS N06625 Pipes{" "}
                  <br className="hidden sm:block" />
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      <tr>
                        ...
                        <td className="px-6 py-2.5 text-sm">58.0 min</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Cr</td>
                        <td className="px-6 py-2.5 text-sm">20.0 - 23.0</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Mo</td>
                        <td className="px-6 py-2.5 text-sm">8.0 - 10.0</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Fe</td>
                        <td className="px-6 py-2.5 text-sm">5.0 max</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2.5 text-sm font-medium">Nb</td>
                        <td className="px-6 py-2.5 text-sm">3.15 - 4.15</td>
                      </tr>
                      <tr>
                  ...
                  <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      <tr>
                        ...
                        <td className="px-4 py-2.5 text-sm">NW 6625</td>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#4A148C] text-center mb-6">
                  EXPORT DESTINATIONS FOR INCONEL 625 PIPES, INCONEL 625 TUBES,{" "}
                  <br className="hidden sm:block" />
                  <span className="text-[#66BB6A]">
                    INCONEL 625 SEAMLESS PIPES, INCONEL 625 WELDED TUBES
                  </span>
                </h2>
